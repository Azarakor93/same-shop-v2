  ...
  Future<void> _soumettre() async {
    ...
    try {
      await _service.creerAnnonce(
        titre: _titreController.text.trim().isEmpty ? null : _titreController.text.trim(),
        imageUrl: _imageUrlController.text.trim(),
        lienType: _lienType,
        lienValeur: _lienValeurController.text.trim().isEmpty ? null : _lienValeurController.text.trim(),
        dateFin: _dureeJours == null ? null : DateTime.now().add(Duration(days: _dureeJours!)),
      );
