...
class _EcranOtpEmailState extends State<EcranOtpEmail> {
  ...
  Future<void> _confirmerOtp() async {
    ...
    // ✅ BYPASS DEV
    if (_codeOtp != '939393') {
      SnackService.afficher(context, message: Langage.t(context, 'otp_invalid'), erreur: true);
      return;
    }
    ...
    SnackService.afficher(context, message: Langage.t(context, 'account_confirmed'));
