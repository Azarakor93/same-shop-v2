...
class SelecteurCategorie extends StatefulWidget {
  ...
  /// Helper statique pour ouvrir le sélecteur en bottom sheet
  static Future<Map<String, String>?> afficherCategorie({
        ...
        return SafeArea(
          child: Padding(
            ...
            child: SingleChildScrollView(
              child: SelecteurCategorie(
                categorieSelectionneeId: categorieActuelleId,
                onCategorieSelectionnee: (id, chemin) {
                  result = {'id': id, 'nomComplet': chemin};
