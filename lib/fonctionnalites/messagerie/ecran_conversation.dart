    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: estMoi ? theme.colorScheme.primary : theme.colorScheme.surfaceContainerHighest,
        ...
        child: Column(
          ...
          children: [
            Text(
              message.contenu,
              style: TextStyle(
                color: estMoi ? theme.colorScheme.onPrimary : theme.colorScheme.onSurface,
              ),
            ),
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 11,
                color: estMoi ? theme.colorScheme.onPrimary.withValues(alpha: 0.8) : theme.colorScheme.onSurface.withValues(alpha: 0.6),
              ),
            ),
          ],
        ),
